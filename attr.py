...
#实体id和属性
ent1_attr = load_ent_attr('/id1_attr_'+ la +'_en') #实体id和属性
...
write2file(lang + '/final_attr', final_attr)
write2file(lang + '/max_n_attr', max_n_attr)
write2file(lang + '/max_p_attr', max_p_attr)
